...
public class StateManager {
	...
	public static boolean isAiMovingFirst; // who moves first hands the first piece; second move = place piece + choose
											// piece
	...
	// this method can be called without boardParam argument, so it must be checked
	// for null
